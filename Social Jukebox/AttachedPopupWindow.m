...
#define MAATTACHEDWINDOW_DEFAULT_BACKGROUND_COLOR [NSColor colorWithCalibratedWhite:0.1 alpha:1.0]
...
@interface AttachedPopupWindow (MAPrivateMethods)
...
@implementation AttachedPopupWindow
                        ...
                        atDistance:(float)distance
{
    ...
    if ((self = [super initWithContentRect:contentRect 
        ...
        [self setBorderColor: [NSColor colorWithCalibratedWhite:.97 alpha:1.0]];
        [self setViewMargin:2];
        [self setBorderWidth:2];
        [self setCornerRadius:4];
        [self setHasArrow: YES];
        [self setDrawsRoundCornerBesideArrow:NO];
        [self setArrowBaseWidth:21];
        [self setArrowHeight:7];
    }
    open = FALSE;
    return self;
}
